        ...
        if(!fechaent.equalsIgnoreCase(fechaact)){
            ...
            if(ae==aa){
                if(me==ma){
                    ...
                    if(difm!=1){
                        ...
                        if(me==1||me==3||me==5||me==7||me==8||me==10||me==12)
                            multa= multa+31-de+da;
                        if(me==2){
                            if(ae%4==0) b=1;
                            if(ae%100==0) b=0;
                            if(ae%100==0) b=1;
                            if(b==1) multa= multa+29-de+da;
                            else multa= multa+28-de+da;
                        }//me==2
                        if(me==4||me==6||me==9||me==11)multa= multa+30-de+da;
                    }
                }//else
            }//ae==aa
            else{
                ...
                if(de!=da){
                    ...
                    if(me==4||me==6||me==9||me==11)difd=30-de;
                }
                multa= multa+difd;
            }//else año
        }
